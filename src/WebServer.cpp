    ...
    while (true) {
        ...
        try {
            if (path == "/login") {
                ...
                html.replace(html.find(marker), marker.size(), std::string(dashboardVersion()) + releaseNotice() + categoryEnhancements() + marker);
